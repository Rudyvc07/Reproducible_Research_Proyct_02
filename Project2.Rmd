...
```{r}
stormData <- read.csv("D:/Rudy/Especializacion/Especializacion Data Science/Reproducible Research/Proyecto 2/Reproducible_Research_Proyct_02/repdata_data_StormData/repdata_data_StormData.csv")
head(stormData)
```
...
```{r}
library(ggplot2)
fatalitiesPlot <- qplot(EVTYPE, data = fatalities, weight = FATALITIES, geom = "bar")+    scale_y_continuous("Number of Fatalities") + 
...
Histograms show us that floods and **hurricanes / typhoons** cause the most property damage; Drought and floods caused the majority of crop damage in the United States from 1995 to 2011.
